...
const heroPhoto: Record<string, string> = {
  ...
  'siding-replacement': '/showcase/house%20(2).png',
...
const sharePhoto: Record<string, string> = {
  ...
  'siding-replacement': '/work/siding-siding1.webp',
...
const processPhoto: Record<string, string> = {
  ...
  'siding-replacement': '/Siding/optimized/siding (11).webp',
