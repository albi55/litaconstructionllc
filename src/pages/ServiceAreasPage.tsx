...
/** Real project photo per service, for the "Services near you" cards. */
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden text-white">
        ...
        />
        <div
          className="pointer-events-none absolute inset-0 bg-gradient-to-r from-navy-950 via-navy-950/85 to-navy-950/50"
          aria-hidden="true"
        />
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-5 text-lg leading-relaxed text-cloud-600">
                A sample of the communities we work in every week — don&apos;t see yours? Call us;
        ...
        <div ref={whyRef} className="reveal container-x relative">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {whyLocal.map((v) => (
              <div
                key={v.title}
                className="h-full rounded-2xl border border-white/10 bg-white/[0.04] p-7 transition-colors duration-300 hover:border-brand-400/40 hover:bg-white/[0.07]"
              >
