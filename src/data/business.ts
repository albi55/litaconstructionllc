...
export const services: Service[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Do I need a permit to replace my roof in New Jersey, and will you handle it?", a: "No — a permit is not required to replace a roof in New Jersey. Because water entering your home is treated as emergency work, roof replacement is exempt from the permit process, so there is nothing for you to file and no waiting on township paperwork. As a licensed NJ Home Improvement Contractor (#13VH11703800), we handle the job to code from start to finish." },
    ],
  ...
  },
  {
    ...
    process: [
      ...
      { title: "Scheduling", description: "Roof replacement is treated as emergency work in New Jersey, so no permit is required and there is nothing for you to file. We lock in a date, schedule the job around the weather, and install your roof to code from start to finish." },
    ...
    faqs: [
      ...
      { q: "Do I need a permit to replace my roof in New Jersey?", a: "No — a permit is not required to replace a roof in New Jersey. Because water entering your home is treated as emergency work, roof replacement is exempt from the permit process, so there is nothing for you to file. As a licensed contractor (NJ Lic. #13VH11703800), we handle the job to code from start to finish." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Do I need a permit for a roof replacement in New Jersey?', a: 'No — a permit is not required to replace a roof in New Jersey. Because water entering your home is treated as emergency work, roof replacement is exempt from the permit process, so there is nothing for you to file. As a licensed contractor, we handle the job to code from start to finish.' },
    ],
